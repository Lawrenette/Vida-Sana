...
function dl_enqueue_style() {
	...
	wp_register_style( 'bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css', null, '4.1.1', 'screen');
	wp_register_style('GoogleFonts', 'https://fonts.googleapis.com/css?family=Delius|Roboto|Poppins|Raleway');
